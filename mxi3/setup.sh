...
yay -Sy
yay -S alacritty dunst i3-gaps-rounded-git i3blocks i3status nitrogen neovim rofi nautilus neofetch polkit-gnome nerd-fonts-jetbrains-mono ttf-jetbrains-mono alacritty-themes
